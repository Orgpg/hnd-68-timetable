...
export default function AssignmentsPage() {
  const assignment1 = assignments.filter((assignment) => assignment.assignmentNo === 1)
  const assignment2 = assignments.filter((assignment) => assignment.assignmentNo === 2)
      ...
      <main className="flex-1 py-8 sm:py-12">
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
              {assignment2.map((assignment, index) => (
                <motion.div
                  key={assignment.no}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
