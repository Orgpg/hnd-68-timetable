...
import {
  aug4_8_2025_daily,
  type DailyEntry as DailyEntryA,
} from "./aug-4-8-2025.ts";
import {
  aug11_sept26_2025_daily,
  type DailyEntry as DailyEntryB,
} from "./aug-11-sept-26-2025.ts";
import {
  septNov2025_daily,
  type DailyEntry as DailyEntryC,
} from "./sept-29-2025-to-nov-19-2025.ts";

export type DailyEntry = DailyEntryA | DailyEntryB | DailyEntryC;
...
export function getPeriodArrayFor(key: string): DailyEntry[] {
  ...
  if (key >= "2025-08-11" && key <= "2025-09-28")
    return aug11_sept26_2025_daily;
...
export function getPeriodLabelFor(key: string): string {
  if (key >= "2025-08-04" && key <= "2025-08-10")
    return "From 4-Aug-2025 to 8-Aug-2025";
  if (key >= "2025-08-11" && key <= "2025-09-28")
    return "From 11-Aug-2025 to 26-Sept-2025";
  if (key >= "2025-09-29" && key <= "2025-11-19")
    return "From 29-Sept-2025 to 19-Nov-2025";
  // Fallbacks
